...
|                       | represent data        | Processing data and   |
|                       |                       | information**         |
|                       | **SC4-WS-06 Working   |                       |
...
|                       |                       | investigations to     |
|                       | **SC4-WS-07 Working   | identify trends,      |
...
| **Example(s):**                                                       |
|                                                                       |
| Fluorine-18 and technetium-99m are used for medical diagnostics;      |
| gold-198 is used to trace factory waste which causes ocean pollution; |
| cobalt-60 is used in gamma irradiation; iodine-131 is used to treat   |
| thyroid cancer and hyperthyroidism; lutetium-177 is used for          |
| treatment of neuroendocrine cancer; americium-241 is used in smoke    |
| detectors.                                                            |
+=======================================================================+
+-----------------------------------------------------------------------+
...
| **Example(s):**                                                       |
|                                                                       |
| Wavelength is equal to the wave velocity divided by frequency.        |
+=======================================================================+
+-----------------------------------------------------------------------+
...
| **Example(s):**                                                       |
|                                                                       |
| EM waves are used in medicine, sanitation, communication.             |
+=======================================================================+
+-----------------------------------------------------------------------+
...
| **Example(s):**                                                       |
|                                                                       |
| Didgeridoo, clapsticks, emu caller.                                   |
+=======================================================================+
+-----------------------------------------------------------------------+
...
| **Example(s):**                                                       |
|                                                                       |
| Ultrasound is used in medical diagnosis to visualise internal         |
| structures and monitor foetal development using high-frequency sound  |
| waves; Doppler ultrasound is used to assess blood flow and detect     |
| vascular issues by measuring changes in the frequency of sound waves  |
| reflected from moving blood cells.                                    |
+=======================================================================+
+-----------------------------------------------------------------------+
...
| **Example(s):**                                                       |
|                                                                       |
| Investigating ray boxes, mirrors and different media, or by using     |
| interactive materials, such as a simulation.                          |
+=======================================================================+
+-----------------------------------------------------------------------+
...
| **Example(s):**                                                       |
|                                                                       |
| A star's colour provides a direct measurement of its surface          |
| temperature.                                                          |
+=======================================================================+
+-----------------------------------------------------------------------+
...
| **Example(s):**                                                       |
|                                                                       |
| Using light gates, ticker timers, crash carts, rolling model cars     |
| across a floor to measure distance and time.                          |
+=======================================================================+
+-----------------------------------------------------------------------+
...
| **Example(s):**                                                       |
|                                                                       |
| Pulleys attached to masses and ticker timers, light gates or other    |
| sensors.                                                              |
+=======================================================================+
+-----------------------------------------------------------------------+
...
| **Example(s):**                                                       |
|                                                                       |
| Rockets deliver satellites to space which allows for use of mobile    |
| phones and GPS; radio telescopes communicate with satellites; optical |
| fibres in medicine (endoscopes) and communication (high-speed         |
| internet).                                                            |
+=======================================================================+
+-----------------------------------------------------------------------+
...
| **Example(s):**                                                       |
|                                                                       |
| Consider how data processing, analysis and representation can affect  |
| the conclusions reached, and how data variation can indicate          |
| uncertainty and may influence the strength of the evidence and        |
...
| **Example(s):**                                                       |
|                                                                       |
| Pseudoscience refers to claims presented as alternative explanations  |
| of natural phenomena that have not been developed using               |
...
| **Example(s):**                                                       |
|                                                                       |
| Astrology, cryptozoology, flat-Earth theory, 'water witching'         |
| (dowsing).                                                            |
+=======================================================================+
+-----------------------------------------------------------------------+
...
| **Example(s):**                                                       |
|                                                                       |
| A univariate analysis could measure height; a bivariate analysis      |
| could measure the number of ice cream sales and temperature during    |
| summer.                                                               |
+=======================================================================+
+-----------------------------------------------------------------------+
...
| **Example(s):**                                                       |
|                                                                       |
| Gregor Mendel's experiments with pea plants; astronomer Vera Rubin's  |
| discovery of the existence of dark matter and how her claims were     |
| validated; global climate models.                                     |
+=======================================================================+
+-----------------------------------------------------------------------+
